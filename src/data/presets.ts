...
export const TRIP_PRESETS: TripPreset[] = [
  {
    ...
    waypoints: [
      ...
      { lat: 43.5855, lng: 11.3168, title: 'Antica Macelleria & Ristoro Chianti', address: 'Greve in Chianti, Firenze', category: 'food' },
  ...
  },
  {
    ...
    waypoints: [
      ...
      { lat: 40.6482, lng: 14.7011, title: 'Trattoria del Mare & Colatura di Alici', address: 'Cetara, Salerno', category: 'food' },
  ...
  },
  {
    ...
    waypoints: [
      ...
      { lat: 46.5490, lng: 11.9320, title: 'Rifugio & Baita Tipica Val Badia', address: 'Corvara in Badia, Bolzano', category: 'food' },
